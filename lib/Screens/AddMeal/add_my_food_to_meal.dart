...
class AddMyFoodToMeal extends StatefulWidget {
  int meal_id;
  AddMyFoodToMeal(this.meal_id, {super.key});

  @override
  State<AddMyFoodToMeal> createState() => _AddMyFoodToMealState();
}

class _AddMyFoodToMealState extends State<AddMyFoodToMeal> {
          ...
          _isFoodsLoading
              ...
              : Column(
                ...
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.all(20),
                    child: heading("My Saved Foods"),
                  ),
                  Expanded(
                    child: ListView(
                      padding: EdgeInsets.all(20),
                      children: [
                        Column(children: myFoodItemsWidgetList()),
                        // Column(children: searchedItemsList()),
                      ],
                    ),
                  ),
                ],
  ...
  itemDetailWidget(Map data, StateSetter setState) {
    ...
    if (data['food_serving_sizes'].length > 0) {
